      ...
      <div className="container mx-auto px-4 py-20 animate-fade-in">
        ...
        <div className="max-w-3xl mx-auto space-y-12">
          <section className="bg-white rounded-xl shadow-[0_4px_20px_rgba(11,46,89,0.08)] p-10">
            <h2 className="text-2xl font-semibold text-school-navy mb-6 flex items-center gap-3">
              <span className="flex-shrink-0" aria-hidden="true">
                <svg className="w-5 h-5 text-school-gold" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
