...
export default function TopBar() {
  return (
    <div
      className="w-full min-h-[38px] flex items-center text-[#fff8e6] font-medium tracking-[0.3px]"
      style={{
        background: "linear-gradient(to right, #9A5B00, #C87400, #E39B2D)",
      ...
      <div className="container mx-auto px-4 py-2 flex flex-wrap items-center justify-center sm:justify-between gap-3 sm:gap-[12px] text-[14px]">
        ...
        <div className="flex items-center gap-[12px] flex-shrink-0 min-w-0">
          <a
            ...
            className="flex items-center gap-1.5 hover:opacity-90 transition-opacity whitespace-nowrap min-w-0 text-[#fff8e6]"
          >
          ...
          <a
            href="tel:9100569269"
            className="flex items-center gap-1.5 hover:opacity-90 transition-opacity whitespace-nowrap flex-shrink-0 text-[#fff8e6]"
          >
