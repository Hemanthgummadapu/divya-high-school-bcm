          ...
          <div>
            <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
              <Image
                ...
                alt="Divya High School logo"
                width={40}
                height={40}
                className="w-10 h-10 shrink-0 rounded-full object-contain"
              />
            ...
            <ul className="footer-contact-list">
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-amber-400 hover:text-amber-300 font-medium text-sm transition mt-2 group"
                >
                  View on Google Maps
                  <ExternalLink
                    className="w-3.5 h-3.5 shrink-0 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform"
                    aria-hidden
                  />
                </a>
              </li>
