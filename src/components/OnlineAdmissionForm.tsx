...
type OnlineAdmissionFormProps = {
  /** When true, renders without full-page chrome (for /admissions embed) */
  embedded?: boolean;
};

export default function OnlineAdmissionForm({ embedded = false }: OnlineAdmissionFormProps) {
  ...
  if (submitted) {
    return (
      <div className={embedded ? "" : "min-h-screen bg-[#f0f4f8] py-20 md:py-28 flex items-center"}>
        <div className={embedded ? "max-w-2xl mx-auto" : "container mx-auto px-4"}>
          <div className="bg-white rounded-2xl shadow-[0_4px_28px_rgba(11,46,89,0.06)] p-8 md:p-12 text-center">
            ...
            <h2 className="text-2xl font-bold text-school-navy mb-4">Application Submitted</h2>
    ...
    <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-[0_4px_28px_rgba(11,46,89,0.06)] p-6 md:p-10">
      ...
      <div className="space-y-6 mb-10">
        ...
        <div>
          ...
          <select id="gender" name="gender" className={`${inputBase} ${errors.gender ? inputError : ""}`}>
      ...
      <div className="space-y-6 mb-10">
        ...
        <div>
          ...
          <input id="mothersName" name="mothersName" type="text" className={inputBase} placeholder="Mother's name" />
        </div>
        <div>
      ...
      <div className="space-y-6 mb-10">
        <div>
          ...
          <textarea id="address" name="address" rows={4} className={inputBase} placeholder="Complete address" />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            <input id="city" name="city" type="text" className={inputBase} placeholder="City" />
          </div>
          <div>
            <label htmlFor="state" className={labelClass}>
              State
            </label>
            <input id="state" name="state" type="text" className={inputBase} placeholder="State" />
          </div>
          <div>
            <label htmlFor="pincode" className={labelClass}>
              Pincode
            </label>
            <input id="pincode" name="pincode" type="text" className={inputBase} placeholder="Pincode" maxLength={6} />
          </div>
        </div>
      </div>
  ...
  if (embedded) {
    return <div className="max-w-2xl mx-auto">{formEl}</div>;
  }
    ...
    <div className="min-h-screen bg-[#f0f4f8] py-12 md:py-20">
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-4xl font-bold text-center text-school-navy mb-4">Online Admission Form</h1>
